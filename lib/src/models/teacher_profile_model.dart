...
GetTeacherProfileModel getTeacherProfileModelFromJson(String str) =>
    GetTeacherProfileModel.fromJson(json.decode(str));
String getTeacherProfileModelToJson(GetTeacherProfileModel data) =>
    json.encode(data.toJson());

class GetTeacherProfileModel {
  ...
  GetTeacherProfileModel.fromJson(dynamic json) {
  ...
  String? _message;
  dynamic _errors;
  GetTeacherProfileModel copyWith({
    Data? data,
    bool? success,
    String? message,
    dynamic errors,
