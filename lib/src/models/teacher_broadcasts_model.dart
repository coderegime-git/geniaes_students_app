...
GetTeacherBroadcastsModel getTeacherBroadcastsModelFromJson(String str) =>
    GetTeacherBroadcastsModel.fromJson(json.decode(str));
String getTeacherBroadcastsModelToJson(GetTeacherBroadcastsModel data) =>
    json.encode(data.toJson());

class GetTeacherBroadcastsModel {
  GetTeacherBroadcastsModel({
    GetTeacherBroadcastsDataModel? data,
    bool? success,
    String? message,
    dynamic errors,
  }) {
  ...
  GetTeacherBroadcastsModel.fromJson(dynamic json) {
    _data = json['data'] != null
        ? GetTeacherBroadcastsDataModel.fromJson(json['data'])
        : null;
    _success = json['success'];
    _message = json['message'];
    _errors = json['errors'];
  }
  GetTeacherBroadcastsDataModel? _data;
  bool? _success;
  String? _message;
  dynamic _errors;
  GetTeacherBroadcastsModel copyWith({
    GetTeacherBroadcastsDataModel? data,
    bool? success,
    String? message,
    dynamic errors,
  ...
  GetTeacherBroadcastsDataModel? get data => _data;
...
GetTeacherBroadcastsDataModel getTeacherBroadcastsDataModelFromJson(
        String str) =>
    GetTeacherBroadcastsDataModel.fromJson(json.decode(str));
String getTeacherBroadcastsDataModelToJson(
        GetTeacherBroadcastsDataModel data) =>
    json.encode(data.toJson());

class GetTeacherBroadcastsDataModel {
  ...
  GetTeacherBroadcastsDataModel.fromJson(dynamic json) {
    if (json['data'] != null) {
      _data = [];
      json['data'].forEach((v) {
  ...
  Links? _links;
  Meta? _meta;
  GetTeacherBroadcastsDataModel copyWith({
    List<BroadcastModel>? data,
    Links? links,
    Meta? meta,
  }) =>
