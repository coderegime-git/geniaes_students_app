...
GetStudentAppointmentHistoryModel getStudentAppointmentHistoryModelFromJson(
        String str) =>
    GetStudentAppointmentHistoryModel.fromJson(json.decode(str));
String getStudentAppointmentHistoryModelToJson(
        GetStudentAppointmentHistoryModel data) =>
    json.encode(data.toJson());

class GetStudentAppointmentHistoryModel {
  GetStudentAppointmentHistoryModel({
    GetStudentAppointmentHistoryDataModel? data,
    bool? success,
    String? message,
    dynamic errors,
  }) {
  ...
  GetStudentAppointmentHistoryModel.fromJson(dynamic json) {
    _data = json['data'] != null
        ? GetStudentAppointmentHistoryDataModel.fromJson(json['data'])
        : null;
    _success = json['success'];
    _message = json['message'];
    _errors = json['errors'];
  }
  GetStudentAppointmentHistoryDataModel? _data;
  bool? _success;
  String? _message;
  dynamic _errors;
  GetStudentAppointmentHistoryModel copyWith({
    GetStudentAppointmentHistoryDataModel? data,
    bool? success,
    String? message,
    dynamic errors,
  ...
  GetStudentAppointmentHistoryDataModel? get data => _data;
...
GetStudentAppointmentHistoryDataModel dataFromJson(String str) =>
    GetStudentAppointmentHistoryDataModel.fromJson(json.decode(str));
String dataToJson(GetStudentAppointmentHistoryDataModel data) =>
    json.encode(data.toJson());

class GetStudentAppointmentHistoryDataModel {
  GetStudentAppointmentHistoryDataModel({
    List<StudentAppointmentHistoryModel>? data,
    Links? links,
    Meta? meta,
  }) {
    _data = data;
  ...
  GetStudentAppointmentHistoryDataModel.fromJson(dynamic json) {
    if (json['data'] != null) {
      _data = [];
      json['data'].forEach((v) {
        _data?.add(StudentAppointmentHistoryModel.fromJson(v));
      });
    }
    _links = json['links'] != null ? Links.fromJson(json['links']) : null;
    _meta = json['meta'] != null ? Meta.fromJson(json['meta']) : null;
  }
  List<StudentAppointmentHistoryModel>? _data;
  Links? _links;
  Meta? _meta;
  GetStudentAppointmentHistoryDataModel copyWith({
    List<StudentAppointmentHistoryModel>? data,
    Links? links,
    Meta? meta,
  }) =>
  ...
  List<StudentAppointmentHistoryModel>? get data => _data;
...
StudentAppointmentHistoryModel studentAppointmentHistoryModelFromJson(
        String str) =>
    StudentAppointmentHistoryModel.fromJson(json.decode(str));
String studentAppointmentHistoryModelToJson(
        StudentAppointmentHistoryModel data) =>
    json.encode(data.toJson());

class StudentAppointmentHistoryModel {
