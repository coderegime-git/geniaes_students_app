...
GetAllTopRatedTeachersModel getAllTopRatedTeachersModelFromJson(String str) =>
    GetAllTopRatedTeachersModel.fromJson(json.decode(str));
String getAllTopRatedTeachersModelToJson(GetAllTopRatedTeachersModel data) =>
    json.encode(data.toJson());

class GetAllTopRatedTeachersModel {
  ...
  GetAllTopRatedTeachersModel.fromJson(dynamic json) {
    if (json['data'] != null) {
      _data = [];
      json['data'].forEach((v) {
  ...
  String? _message;
  dynamic _errors;
  GetAllTopRatedTeachersModel copyWith({
    List<TeacherModel>? data,
    bool? success,
    String? message,
    dynamic errors,
...
GetAllTopRatedTeachersDataModel dataFromJson(String str) =>
    GetAllTopRatedTeachersDataModel.fromJson(json.decode(str));
String dataToJson(GetAllTopRatedTeachersDataModel data) =>
    json.encode(data.toJson());

class GetAllTopRatedTeachersDataModel {
  GetAllTopRatedTeachersDataModel({
    num? id,
    num? userId,
    dynamic countryId,
    dynamic stateId,
  ...
  GetAllTopRatedTeachersDataModel.fromJson(dynamic json) {
    _id = json['id'];
  ...
  String? _createdAt;
  String? _updatedAt;
  GetAllTopRatedTeachersDataModel copyWith({
    num? id,
    num? userId,
    dynamic countryId,
    dynamic stateId,
