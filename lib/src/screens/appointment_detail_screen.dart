                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        Text(
                                          ...
                                          style: AppTextStyles.bodyTextStyle14.copyWith(fontWeight: FontWeight.bold, color: Colors.black),
                                        ),
                                        ...
                                        Row(
                                          children: [
                                            Text(
                                              "Rating:",
                                              style: AppTextStyles.bodyTextStyle10.copyWith(fontWeight: FontWeight.bold, color: Colors.black),
                                            ),
                                            SizedBox(width: 4.w),
                                            Row(
                                        ...
                                        if (generalController
                                          ...
                                          Padding(
                                            ...
                                            child: RichText(
                                              text: TextSpan(
                                                style: AppTextStyles.bodyTextStyle10.copyWith(color: Colors.black),
                                                children: [
                                                  TextSpan(
                                                    text: "Comment: ",
                                                  ...
                                                  TextSpan(
                                                    text: generalController.selectedAppointmentHistoryForView.comment!,
                                                  ),
                                                ],
                                              ),
                                            ),
